<div class="students index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($student['User']['email'], array('controller' => 'users', 'action' => 'view', $student['User']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($student['Course']['title'], array('controller' => 'courses', 'action' => 'view', $student['Course']['id'])); ?>
		</td>
		<td class="actions">
