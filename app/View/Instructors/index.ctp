<div class="instructors index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($instructor['User']['email'], array('controller' => 'users', 'action' => 'view', $instructor['User']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($instructor['Course']['title'], array('controller' => 'courses', 'action' => 'view', $instructor['Course']['id'])); ?>
		</td>
		<td class="actions">
